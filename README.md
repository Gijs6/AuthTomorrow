...
A Selenium-based script that "automates" the process of logging into Somtoday by entering your username and password. This allows you to fetch authentication tokens for accessing Somtoday data.
